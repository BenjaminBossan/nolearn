...
def test_plot_functions_with_cnn(mnist):
    from nolearn.lasagne import NeuralNet
    from nolearn.lasagne import plot_conv_activity
    from nolearn.lasagne import plot_conv_weights
    from nolearn.lasagne import plot_loss
